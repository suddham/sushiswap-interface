...
export const MATIC: { [key: string]: Token } = {
  ...
  POLYFRAX: new Token(ChainId.MATIC, '0x104592a158490a9228070E0A8e5343B499e125D0', 18, 'polyFRAX', 'Poly Frax'),
  POLYFXS: new Token(ChainId.MATIC, '0x3e121107F6F22DA4911079845a470757aF4e1A1b', 18, 'polyFXS', 'Poly Frax Share'),
  FRAX: new Token(ChainId.MATIC, '0x45c32fA6DF82ead1e2EF74d17b76547EDdFaFF89', 18, 'FRAX', 'Frax'),
  FXS: new Token(ChainId.MATIC, '0x1a3acf6D19267E2d3e7f898f42803e90C9219062', 18, 'FXS', 'Frax Share'),
